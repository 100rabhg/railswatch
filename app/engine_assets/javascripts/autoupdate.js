...
class RailswatchAutoupdate extends HTMLElement {
  connectedCallback() {
  ...
  morphPage(newDoc) {
    ...
    document.dispatchEvent(new Event('railswatch:content-updated'));
  }

  storageKey() {
    return `railswatch-autoupdate:${window.location.pathname}`;
  }
}

customElements.define('railswatch-autoupdate', RailswatchAutoupdate);
